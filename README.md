...
Yerli optika üçün **no-code Virtual Try-On integrator**. DeepAR/Banuba yox: lisenziya və reseller şərtləri birinci ili yeyər. Stack: **MediaPipe Face Landmarker (brauzerdə) + 2D/sonra 3D overlay**.
...
3. Dashboard-da `ADMIN_PASSWORD` env dəyişənini təyin et.
